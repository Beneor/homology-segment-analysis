...
allFragmentedSeq = open(r"20-words-dir-all.txt", "a+") #Sequence 1 fragments - all iterations
...
for line in sequence:
        ...
        for i in range (1,x1):
                ...
                end= begin+20 #random fragment end
...
fragmentPosition = open(r"20-fragments-d.txt", "a+") # File containing fragment sequences, number and positions of matches
fragmentNumber = open(r"20-dir.txt", "a+") # File containing the total count of matching fragments
...
for fileName in resultFiles:
        ...
        for line in chromosomePart:
                ...
                for line in fragmentSeq:
                        a=str(line)
                        if len(a.strip())!=20: continue # checking the length of random fragment
                        ...
                        if x.count(a.strip())!=0: #checking that fragment is within the analyzed sequence
                                ...
                                while True: # output of fragment positions for multiple matches
                                        ...
                                        start+=20 #Shifting the begin of the scanned area
                                        i+=1
                                fragmentPosition.write(str("\n"))
