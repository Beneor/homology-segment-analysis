...
allFragmentedSeq = open(r"25-words-dir-all.txt", "a+") #Sequence 1 fragments - all iterations
...
fragmentPosition = open(r"25-fragments-d.txt", "a+") # File containing fragment sequences, number and positions of matches
fragmentNumber = open(r"25-dir.txt", "a+") # File containing the total count of matching fragments
