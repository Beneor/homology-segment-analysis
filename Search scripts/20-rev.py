...
allFragmentedSeq = open(r"20-words-rev-all.txt", "a+") #Sequence 1 fragments - all iterations
...
fragmentPosition = open(r"20-fragments-r.txt", "a+") # File containing fragment sequences, number and positions of matches
fragmentNumber = open(r"20-rev.txt", "a+") # File containing the total count of matching fragments
