...
allFragmentedSeq = open(r"5-words-dir-all.txt", "a+") #Sequence 1 fragments - all iterations
...
fragmentPosition = open(r"5-fragments-d.txt", "a+") # File containing fragment sequences, number and positions of matches
