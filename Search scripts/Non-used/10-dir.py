...
fragmentedSeq = open(r"10-words.txt", "w") # Sequence 1 fragments
allFragmentedSeq = open(r"10-words-dir-all.txt", "a+") #Sequence 1 fragments - all iterations
...
for line in sequence:
        ...
        for i in range (1,x1):
                ...
                end= begin+10 #random fragment end
...
fragmentSeq = open(r"10-words.txt", "r") # Sequence 1 fragments
fragmentPosition = open(r"10-fragments-d.txt", "a+") # File containing fragment sequences, number and positions of matches
fragmentNumber = open(r"10-dir.txt", "a+") # File containing the total count of matching fragments
...
for fileName in resultFiles:
        ...
        for line in chromosomePart:
                ...
                for line in fragmentSeq:
                        a=str(line)
                        if len(a.strip())!=10: continue # checking the length of random fragment
                        ...
                        if x.count(a.strip())!=0: #checking that fragment is within the analyzed sequence
                                ...
                                while True: # output of fragment positions for multiple matches
                                        ...
                                        start+=10 #Shifting the begin of the scanned area
                                        i+=1
                                fragmentPosition.write(str("\n"))
