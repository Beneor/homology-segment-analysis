...
fragmentedSeq = open(r"5-words.txt", "w") # Sequence 1 fragments
allFragmentedSeq = open(r"5-words-rev-all.txt", "a+") #Sequence 1 fragments - all iterations
...
fragmentSeq = open(r"5-words.txt", "r") # Sequence 1 fragments
fragmentPosition = open(r"5-fragments-r.txt", "a+") # File containing fragment sequences, number and positions of matches
fragmentNumber = open(r"5-rev.txt", "a+") # File containing the total count of matching fragments
                ...
                for line in fragmentSeq:
                        ...
                        if x.count(a.strip())!=0: #checking that fragment is within the analyzed sequence
                                ...
                                while True: # output of fragment positions for multiple matches
                                        ...
                                        start+=5 #Shifting the begin of the scanned area
                                        i+=1
                                fragmentPosition.write(str("\n"))
