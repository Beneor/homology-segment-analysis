...
fileSuffix='-norm-dir.txt'
filesMask='*'+fileSuffix
resultFiles = glob.glob(filesMask)
newfileSuffix='-temporal-dir.txt'
...
fileSuffix='-temporal-dir.txt'
newfileSuffix='-column-dir.txt'
filesMask='*'+fileSuffix
resultFiles = glob.glob(filesMask)
...
pearsonfile = open(r"Pearson-data-dir.txt","a+")
...
fileSuffix='-temporal-dir.txt' #Deletes -new files
filesMask='*'+fileSuffix
resultFiles = glob.glob(filesMask)
