...
fileSuffix2="-d-new.txt"
newfileSuffix2="-d-list.txt"
...
fileSuffix3='-d-list.txt'
newfileSuffix3='-d-fin.txt'
...
fileSuffix4='-d-fin.txt'
newfileSuffix4='-d-temp.txt'
newfileSuffix5='-d-count.txt'
